 ...
 * {@link Catana.component.chart.ux.serie.MapSerie} for details.
 * Finally, change the constructor
 * to ExtJs style as follows:
 *
 *     var map = Ext.Create('Catana.component.chart.ux.Highmaps', {
 *         chartConfig {
 *              ....
 *         },
 *         series : [{
 ...
 * 
 */
Ext.define("Catana.component.chart.ux.Highmaps", {
    extend: 'Catana.component.chart.ux.Highcharts',
    alias: ['widget.highmaps'],
    mixins: {
        observable: 'Ext.util.Observable'
    },
    basicSerieCls: "Catana.component.chart.ux.serie.MapSerie",
    ...
    addSeries: function (series, append) {
        ...
        var HC = Catana.component.chart.ux.Highcharts;
