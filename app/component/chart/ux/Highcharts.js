 ...
 *
 *       var chart = new Ext.create('Catana.component.chart.ux.Highcharts', {
 *                       ....
 *                   });
 ...
 * to the desired {@link Catana.component.chart.ux.Highcharts.Serie} class and {@link Catana.component.chart.ux.Highcharts.Serie#method-getData}
 ...
 * {@link Catana.component.chart.ux.Highcharts.Serie} class and {@link Catana.component.chart.ux.Highcharts.Serie#cfg-dataIndex} configuration for
 ...
 * created without any datasets. However, the chart initial animation ({@link Catana.component.chart.ux.Highcharts#cfg-initAnimAfterLoad})
 ...
 *          ...
 *      }
 * Once the chart is displayed, the dynamic series can be displayed via {@link Catana.component.chart.ux.Highcharts#method-addSeries} method
 ...
 */
Ext.define("Catana.component.chart.ux.Highcharts", {
    extend: 'Ext.Component',
    alias: ['widget.highchart', 'widget.highcharts'],
    requires: [
        'Catana.component.chart.ux.serie.AreaRangeSerie',
        'Catana.component.chart.ux.serie.AreaSerie',
        'Catana.component.chart.ux.serie.AreaSplineRangeSerie',
        'Catana.component.chart.ux.serie.AreaSplineSerie',
        'Catana.component.chart.ux.serie.BarSerie',
        'Catana.component.chart.ux.serie.BoxPlotSerie',
        'Catana.component.chart.ux.serie.BubbleSerie',
        'Catana.component.chart.ux.serie.ColumnRangeSerie',
        'Catana.component.chart.ux.serie.ColumnSerie',
        'Catana.component.chart.ux.serie.ErrorBarSerie',
        'Catana.component.chart.ux.serie.FunnelSerie',
        'Catana.component.chart.ux.serie.GaugeSerie',
        'Catana.component.chart.ux.serie.HeatmapSerie',
        'Catana.component.chart.ux.serie.LineSerie',
        'Catana.component.chart.ux.serie.MapBubbleSerie',
        'Catana.component.chart.ux.serie.MapLineSerie',
        'Catana.component.chart.ux.serie.MapPointSerie',
        'Catana.component.chart.ux.serie.MapSerie',
        'Catana.component.chart.ux.serie.PieSerie',
        'Catana.component.chart.ux.serie.PyramidSerie',
        'Catana.component.chart.ux.serie.RangeSerie',
        'Catana.component.chart.ux.serie.ScatterSerie',
        'Catana.component.chart.ux.serie.SolidGaugeSerie',
        'Catana.component.chart.ux.serie.SplineSerie',
        'Catana.component.chart.ux.serie.WaterfallSerie'
    ],
    statics: {
        /***
         * @static
    ...
    basicSerieCls: "Catana.component.chart.ux.serie.Serie",
     ...
     * A delay to call {@link Catana.component.chart.ux.Highcharts#method-draw} method
     */
    updateDelay: 0,
    ...
    /**
     * A function to delay the call to {@link Catana.component.chart.ux.Highcharts#method-draw} method
